 ...
 */
function first_theme_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'first_theme_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'first_theme_customize_partial_blogdescription',
			)
		);
	}
	 ...
	 */
		$wp_customize->add_control( 'footer_contact_details_form',
			...
			'description' => esc_html__( 'Enter Contact Details Form that shows in footer' ),
			'section' => 'footer_navigation_section',
			'type' => 'textarea', 
			'input_attrs' => array( // Optional.
				'class' => 'address-field',
	 ...
	 */
		$wp_customize->add_control( 'footer_business_hours',
			...
			'description' => esc_html__( 'Enter Business Hours that shows in footer' ),
			'section' => 'footer_navigation_section',
			'type' => 'textarea', 
			'input_attrs' => array( // Optional.
				'class' => 'address-field',
	 ...
	 */
		$wp_customize->add_control( 'footer_email',
			...
			'description' => esc_html__( 'Enter Email that shows in footer' ),
			'section' => 'footer_navigation_section',
			'type' => 'textarea', 
			'input_attrs' => array( // Optional.
				'class' => 'address-field',
 ...
 * @return void
 */
function first_theme_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function first_theme_customize_partial_blogdescription() {
...
function first_theme_customize_preview_js() {
	wp_enqueue_script( 'first-theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
